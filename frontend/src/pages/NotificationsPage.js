...
const TYPE_CONFIG = {
  ...
  SYSTEM:             { bg: 'bg-gray-100', icon: 'text-gray-500', dot: 'bg-gray-400' },
};
        ...
        <div className="space-y-2">
          {filtered.map((n) => {
            ...
            return (
              <div
                key={n.id}
                className={`bg-white rounded-xl border px-4 py-3.5 flex items-start gap-3.5 transition ${
                  n.read ? 'border-gray-100' : 'border-blue-200 shadow-sm'
                }`}
              >
